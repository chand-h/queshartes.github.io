(function() {
    ...
    Ball = (function() {
        function Ball(owner) {
            ...
            try {
                _ref = this.owner.getSpace(this.r),
                this.x = _ref[0],
                this.y = _ref[1];
            } catch (_error) {
    ...
    BallSpace = (function() {
        ...
        BallSpace.prototype.bounceAll = function() {
            ...
            for (i = _i = 0,
            _ref = this.balls.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
                b1 = this.balls[i];
                for (j = _j = _ref1 = i + 1,
                _ref2 = this.balls.length; _ref1 <= _ref2 ? _j < _ref2 : _j > _ref2; j = _ref1 <= _ref2 ? ++_j : --_j) {
                    b2 = this.balls[j];
                    dx = b2.x - b1.x;
                    dy = b2.y - b1.y;
                    rr = b1.r + b2.r;
